...
function composeArtisResponse(res, artist) {
  // compose and return response with CORS headers
         		...
         		request(bioURL
					  , function (error, response, body) {  
                        if (!error && response.statusCode == 200) {
                          ...
                          // and now, in a series of parallel calls, we get the details on each of the up to 50 albums
		                  ...
		                  /*  NOTE: I can use https://api.spotify.com/v1/albums/?ids=41MnTivkwTO3UUJ8DrqEJJ,6JWc4iAiJ9FjyK0B59ABb4,6UXCm6bOO4gFlDQZV5yL37
		                      to retrieve details for 15 albums at a time - including release date and tracks.  (see https://developer.spotify.com/web-api/get-several-albums/) 
				          */
				        ...
				        }//if bio successfully retrieved
						else {
						  console.log('error '+error+" status "+response.statusCode );
						}//else
						}// callback within request for bio
				);// request for bio
